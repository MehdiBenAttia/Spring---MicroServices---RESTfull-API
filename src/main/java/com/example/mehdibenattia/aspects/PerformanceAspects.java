...
public class PerformanceAspects {
    @Around("execution(public * com.example.mehdibenattia.Services.*.add*(..))") //naaref li ay add bech trajaa objet wel pjp tnajamch tekhdem b void khater les classes taa service mahomch void lkol
